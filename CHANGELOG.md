...
- Cleaner stats bar with colored dot indicators (filled when > 0, empty when 0)
- Group headers now show patch count
- Added visual spacing between groups
- Removed redundant "Applied" section title

## [1.0.7] - 12-12-2025

### Added

- Echo confirmation feedback when accepting default values on prompts
